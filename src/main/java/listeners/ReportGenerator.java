...
public class ReportGenerator implements ITestListener{
    ...
    private ExtentHtmlReporter htmlreporter = new ExtentHtmlReporter(EXTENT_REPORT_FILE);
    private ExtentHtmlReporter moduleWiseHTMLReporter;
...
public void onTestSkipped(ITestResult result) {
    ...
    moduleWiseLogger.log(Status.SKIP, "<b><i>" + "Test skipped due to :: </b></i><textarea>"
            + ExceptionUtil.getStackTrace(result.getThrowable()) + "</textarea>");
